#!/bin/bash
all: resume_2022-08-23.html resume_2021-07-13.html resume_2019-09-18.html resume_2020-01-05.html resume.html index.html
...
resume_2022-08-23.html: resume.hbs resume_2022-08-23.json
	$(HBC) --data resume_2022-08-23.json --output resume_2022-08-23 resume.hbs
